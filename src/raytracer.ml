...
(* TO DO
    dodać kolorki światła i obiektów
    dodać płaszczyznę i jej intersecta
    zmieniać kąt patrzenia
    wektorki normalne point -> vector
    operacje na wektorach (znormalizowane) i kolorki <0, 1>
    cieniowanie -> facing ratio
    lampka : punkt
